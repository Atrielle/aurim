...
- [x] Freeze a canonical proof contract for `sprint-014-proof`.
...
- [x] `tools/harness-runtime/artifacts/runs/sprint-014-proof/04_unit_plan.json`
- [x] `tools/harness-runtime/artifacts/runs/sprint-014-proof/05_unit_reports/WU-001.dispatch.json`
- [x] `tools/harness-runtime/artifacts/runs/sprint-014-proof/05_unit_reports/WU-001.evidence.json`
- [x] `tools/harness-runtime/.runner-state/freeze-proofs/sprint-014-proof.json`
- [x] `tools/harness-runtime/.runner-state/baseline-proofs/sprint-014-proof.json`
